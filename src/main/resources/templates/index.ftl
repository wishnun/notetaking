...
<html>
<head><title></title>
    <link href="techyons.min.css" rel="stylesheet"/>
</head>
<body class="ph3 pt0 pb4 mw7 center sans-serif">
<h1 class="f2 mb0"><span class="gold"></span>note taking app</h1>
<p class="f5 mt1 mb4 lh-copy">A simple note-taking app.</p>
<form action="/notetaking/save-note" method="POST" enctype="multipart/form-data">
    <ol class="list pl0">
        <li class="mv3">
